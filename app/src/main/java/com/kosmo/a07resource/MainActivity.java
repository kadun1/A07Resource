...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textViewCode =
                (TextView)findViewById((R.id.code_textview));
        ImageView imageViewCode =
                (ImageView)findViewById(R.id.code_imageview);
        ...
        textViewCode.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                resources.getDimension(R.dimen.dimenXml)); //텍스트 크기 설정
        textViewCode.setTextColor(ContextCompat.getColor(this,R.color.colorXml)); //텍스트 색깔 설정
